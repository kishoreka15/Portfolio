    ...
    return (
        <div className="header">
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/kishoreka15?tab=repositories" target="_blank" rel="noreferrer">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/kishore-m-aa4aa9353" target="_blank" rel="noreferrer">
...
<p>Location</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-three"><a className="nav-link" href="https://drive.google.com/file/d/1jWC5nojCPg3Ou3kF-LDZk_vVCQrlGpMM/view?usp=share_link" target="_blank" rel="noreferrer">Resume</a></li>
                        <li className="menu-fore"><a className="nav-link" href="mailto:mkishore182005@gmail.com" target="_blank" rel="noreferrer">Contact</a></li>
                    </ul>
                    </div>    
            </div>
            </div>
