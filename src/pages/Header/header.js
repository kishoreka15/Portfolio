    ...
    return (
        <div className="header">
            ...
            <div className="navigation" ref={elSocials}>
                ...
                <a className="github" href="https://github.com/kishoreka15?tab=repositories" target="_blank">
...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/kishore-m-aa4aa9353" target="_blank">
...
<p>LinkedIn</p>
                ...
                <a className="twitter" href="https://67b6ed7a8b150.site123.me/" target="_blank">
...
<p>video editing</p>
                ...
                <a className="schedule" href="https://www.google.com/maps/place/Nagapattinam,+Tamil+Nadu/@10.7795772,79.7814464,20120m/data=!3m2!1e3!4b1!4m6!3m5!1s0x3a556c9797ef6927:0xc869efbb726e6072!8m2!3d10.7672313!4d79.8448512!16zL20vMDJ0bDQy?entry=ttu&g_ep=EgoyMDI1MTEwMi4wIKXMDSoASAFQAw%3D%3D" target="_blank">
...
<p>Location</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-three"><a className="nav-link" href="https://drive.google.com/file/d/1jWC5nojCPg3Ou3kF-LDZk_vVCQrlGpMM/view?usp=share_link" target="_blank">Resume</a></li>
                        <li className="menu-fore"><a className="nav-link" href="mailto:mkishore182005@gmail.com" target="_blank">Contact</a></li>
                    </ul>
                    </div>    
            </div>
            </div>
